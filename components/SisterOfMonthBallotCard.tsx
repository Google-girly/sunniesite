...
export function SisterOfMonthBallotCard({ activeMembers }: { activeMembers: Member[] }) {
  ...
  return (
    <div className="mb-6 rounded-lg border border-rose-200 bg-rose-50/60 p-5">
      ...
      <form onSubmit={handleVote} className="mt-3 flex flex-wrap items-center gap-2">
        <select
          ...
          className="rounded-md border border-stone-300 px-2 py-1.5 text-sm focus:border-rose-400 focus:outline-none focus:ring-1 focus:ring-rose-400"
        >
